...
extension Signal {
	...
	public func take(referring object: AnyObject) -> Signal<Value, Error> {
...
extension SignalProducer {
	...
	public func take(referring object: AnyObject) -> SignalProducer<Value, Error> {
		return lift { $0.take(referring: object) }
	}
}
